...
module.exports = {
    ...
    .addComponents(button)
        ...
        **Это \`общее\` меню, им могут пользоваться все!**
        **Ссылка на добавление в случае, если нет слеш команд** - [Нажать](https://discord.com/oauth2/authorize?client_id=736853019282636851&scope=bot+applications.commands&permissions=2097147135) 
        **В связи с последними событиями в мире, на всех серверах действует бесплатный премиум (Если хотите поддержать проект, то в выпадающем меню выберите соотвествующую категорию)**
        ...
        message.channel.send({embeds:[emb],components:[row,buttons]})
    }
        }